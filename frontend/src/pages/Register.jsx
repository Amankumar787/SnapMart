    ...
    <div style={{ minHeight: "100vh", background: "#0D0B1F", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: "420px", animation: "fadeUp 0.5s ease both" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <p style={{ marginTop: "8px", fontSize: "14px", color: "#B8B5CC" }}>Create your account and start shopping!</p>
        </div>

        {/* Card */}
        <div style={{ background: "#1A1730", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "20px", padding: "36px" }}>
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: "22px", fontWeight: 700, marginBottom: "24px", color: "#fff" }}>Create account</h2>

          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <div>
              <label style={{ fontSize: "12px", color: "#B8B5CC", marginBottom: "6px", display: "block" }}>Full name</label>
              <input className="auth-input" type="text" name="name" placeholder="John Doe" value={form.name} onChange={handleChange} />
            </div>
            ...
            <div>
              ...
              <input className="auth-input" type="password" name="password" placeholder="Min 6 characters" value={form.password} onChange={handleChange} />
            </div>

            <div>
              <label style={{ fontSize: "12px", color: "#B8B5CC", marginBottom: "6px", display: "block" }}>Confirm password</label>
              <input className="auth-input" type="password" name="confirmPassword" placeholder="••••••••" value={form.confirmPassword} onChange={handleChange} />
            </div>
          ...
          <p style={{ marginTop: "20px", textAlign: "center", fontSize: "13px", color: "#B8B5CC" }}>
            ...
            <Link to="/login" style={{ color: "#FFD600", textDecoration: "none", fontWeight: 500 }}>Sign in</Link>
          </p>
        </div>
      </div>
    </div>
